										...
										<table class="table  table-bordered table-hover" id="dataTables-example" >
									        ...
									        <tbody>
												<?php
													...
													$query=mysqli_query($con,"select student .* , selectedleader .* from student , selectedleader where student.RegNo = selectedleader.RegNo && not Possition ='Former President' && StudentStatus='Enable'  && Possition !='Former DSR' && Possition != 'Former Vice President' && ElectedYear = '".$leaderQuery['ElectedYear']."'");
