					...
					<ul class="nav nav-bg-cl">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="student.php"><i class="fa fa-id-card-o"></i> <span>All student</span></a></li>
									<li><a href="student_loan.php"><i class="fa fa-hospital-o"></i> <span>Std loan</span></a></li>
									<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
										<i class="fa fa-file-text-o"></i><span>Loan reports</span></a>
											<ul class="dropdown-menu  nav" style="border: 0px solid black; width: 100%;">
												<li><a href="report_loan.php" target="_blank"><i class="fa fa-file-pdf-o"></i> <span>Loan Report</span></a></li>
												<!-- <li><a href="report_loan_no.php" class=""><i class="fa fa-file-code-o"></i> <span>Std Report</span></a></li> -->
											</ul>
									</li>
								</ul>
							</div>
