<?php
	...
	$seleader = mysqli_query($con,"select * from selectedleader where RegNo ='$id'");
	$leaderow = mysqli_fetch_array($seleader);

	// third line
	$proposal ='MASO BUDGET REPORT IN ACADEMIC  YEAR '.$leaderow['ElectedYear'];
	...
	*/
	...
	$seloan = mysqli_query($con,"select selectedleader .* , minister .* from selectedleader , minister where selectedleader.LeaderID = minister.LeaderID && ElectedYear ='".$leaderow['ElectedYear']."' && 	MinisterPossition ='Minister of Loan'");
	...
	// fouth line
	$am ="I am ".$qlstd['FirstName'].", ".$qlstd['MiddleName'].", ".$qlstd['LastName']." ".$qloan['MinisterPossition']." in academic year ".$leaderow['ElectedYear'].". This is the budget report in ";
	...
	$am4 ="academic year.. ".$leaderow['ElectedYear'];
	$fpdf -> Ln(8);
	...
	while ($loanquery=mysqli_fetch_array($loanevent)) 
		...
		$nbd="The Total Budget in ".$qloan['MinisterPossition']." in academic yaer ".$leaderow['ElectedYear']." is ".$Total_Loan;
		$fpdf -> Ln(15);
		$fpdf -> SetFont('Times','B',12);
	...
	{
		echo "<script> alert('MINISTER OF LOAN IS NOT SELECTED IN THIS ACADEMIC YEAR'); </script> .<script>window.location='index.php'</script>";
	}
	...
	*/
	...
	$selehealth = mysqli_query($con,"select selectedleader .* , minister .* from selectedleader , minister where selectedleader.LeaderID = minister.LeaderID && ElectedYear ='".$leaderow['ElectedYear']."' && 	MinisterPossition ='Minister of Health'");
	...
	// fouth line
	$amh ="I am ".$qhstd['FirstName'].", ".$qhstd['MiddleName'].", ".$qhstd['LastName']." ".$qhealth['MinisterPossition']." in academic year ".$leaderow['ElectedYear'].". This is the budget  ";
	...
	$am4h ="academic year.. ".$leaderow['ElectedYear'];
	$fpdf -> Ln(8);
	$fpdf -> SetFont('Times','',12);
	...
	while ($health_query=mysqli_fetch_array($health_event)) 
		...
		$nbh="The Total Budget in ".$qhealth['MinisterPossition']." in academic yaer ".$leaderow['ElectedYear']." is ".$Total_Health;
		$fpdf -> Ln(15);
		$fpdf -> SetFont('Times','B',12);
	...
	{
		echo "<script> alert('MINISTER OF HEALTH IS NOT SELECTED IN THIS ACADEMIC YEAR'); </script> .<script>window.location='index.php'</script>";
	}
	...
	*/
	...
	$selinfo = mysqli_query($con,"select selectedleader .* , minister .* from selectedleader , minister where selectedleader.LeaderID = minister.LeaderID && ElectedYear ='".$leaderow['ElectedYear']."' && 	MinisterPossition ='Minister of Information'");
	...
	// fouth line
	$aminfo ="I am ".$qinstd['FirstName'].", ".$qinstd['MiddleName'].", ".$qinstd['LastName']." ".$qinfo['MinisterPossition']." in academic year ".$leaderow['ElectedYear'].". This is the budget report";
	...
	$am4i ="academic year.. ".$leaderow['ElectedYear'];
	$fpdf -> Ln(8);
	$fpdf -> SetFont('Times','',12);
	...
	// information total overal
	 ...
	 while ($info_query=mysqli_fetch_array($info_event)) 
		...
		$nbi="The Total Budget in ".$qinfo['MinisterPossition']." in academic yaer ".$leaderow['ElectedYear']." is ".$Total_Info;
		$fpdf -> Ln(15);
		$fpdf -> SetFont('Times','B',12);
	...
	{
		echo "<script> alert('MINISTER OF INFORMATION, ARTS, CULTURE AND SPORTS IS NOT SELECTED IN THIS ACADEMIC YEAR'); </script> .<script>window.location='index.php'</script>";
	}
	...
	*/
	...
	// to get  minister of Information,
	$seledu = mysqli_query($con,"select selectedleader .* , minister .* from selectedleader , minister where selectedleader.LeaderID = minister.LeaderID && ElectedYear ='".$leaderow['ElectedYear']."' && 	MinisterPossition ='Minister of Education'");
	...
	// fouth line
	$amedu ="I am ".$qedustd['FirstName'].", ".$qedustd['MiddleName'].", ".$qedustd['LastName']." ".$qedu['MinisterPossition']." in academic year ".$leaderow['ElectedYear'].". This is the budget ";
	...
	$am4e ="academic year.. ".$leaderow['ElectedYear'];
	$fpdf -> Ln(8);
	$fpdf -> SetFont('Times','',12);
	...
	// education total overal
	 ...
	 // event name
	  ...
	  while ($edu_query=mysqli_fetch_array($edu_event)) 
		...
		$nbe="The Total Budget in ".$qedu['MinisterPossition']." in academic yaer ".$leaderow['ElectedYear']." is ".$Total_Edu;
		$fpdf -> Ln(15);
		$fpdf -> SetFont('Times','B',12);
	...
	{
		echo "<script> alert('MINISTER OF EDUCATION IS NOT SELECTED IN THIS ACADEMIC YEAR'); </script> .<script>window.location='index.php'</script>";
	}
	...
	*/
	...
	// to get  minister of Information,
	$selesecu = mysqli_query($con,"select selectedleader .* , minister .* from selectedleader , minister where selectedleader.LeaderID = minister.LeaderID && ElectedYear ='".$leaderow['ElectedYear']."' && 	MinisterPossition ='Minister of Security'");
	...
	// fouth line
	$amsecu ="I am ".$qsecustd['FirstName'].", ".$qsecustd['MiddleName'].", ".$qsecustd['LastName']." ".$qsecu['MinisterPossition']." in academic year ".$leaderow['ElectedYear'].". This is the budget ";
	$am1e="event in ministry  and 75000 Tsh for clothes and shoes. The table bellow show ministry expendicture in";
	...
	$fpdf -> Cell(190,8,$am4e,0,2,'C');
	 ...
	 // event name
	  ...
	  while ($secu_query=mysqli_fetch_array($secu_event)) 
		...
		$nbse="The Total Budget in ".$qsecu['MinisterPossition']." in academic yaer ".$leaderow['ElectedYear']." is ".$Total_Secu;
		$fpdf -> Ln(15);
		$fpdf -> SetFont('Times','B',12);
	...
	{
		echo "<script> alert('MINISTER OF SECURITY IS NOT SELECTED IN THIS ACADEMIC YEAR'); </script> .<script>window.location='index.php'</script>";
	}
	...
	*/
	...
	// to get  minister of Information,
	$selewe = mysqli_query($con,"select selectedleader .* , minister .* from selectedleader , minister where selectedleader.LeaderID = minister.LeaderID && ElectedYear ='".$leaderow['ElectedYear']."' && 	MinisterPossition ='Minister of Women'");
	...
	// fouth line
	$amwomen ="I am ".$qwomestd['FirstName'].", ".$qwomestd['MiddleName'].", ".$qwomestd['LastName']." ".$qwemo['MinisterPossition']." in academic year ".$leaderow['ElectedYear'].". This is the budget ";
	$am1e="event in ministry  and 75000 Tsh for clothes and shoes. The table bellow show ministry expendicture in";
	...
	$WomenTotal = 0;
	 ...
	 // event name
	  ...
	  while ($women_query=mysqli_fetch_array($women_event)) 
		...
		$nbwo="The Total Budget in ".$qwemo['MinisterPossition']." in academic yaer ".$leaderow['ElectedYear']." is ".$Total_Women;
		$fpdf -> Ln(15);
		$fpdf -> SetFont('Times','B',12);
	...
	{
		echo "<script> alert('MINISTER OF WOMEN IS NOT SELECTED IN THIS ACADEMIC YEAR'); </script> .<script>window.location='index.php'</script>";
	}
	...
	*/
	...
	// to get  minister of Information,
	$selefine = mysqli_query($con,"select selectedleader .* , minister .* from selectedleader , minister where selectedleader.LeaderID = minister.LeaderID && ElectedYear ='".$leaderow['ElectedYear']."' && 	MinisterPossition ='Minister of Finance'");
	...
	// fouth line
	$finance ="I am ".$qfinestd['FirstName'].", ".$qfinestd['MiddleName'].", ".$qfinestd['LastName']." ".$qfine['MinisterPossition']." in academic year ".$leaderow['ElectedYear'].". This is the budget ";
	$am1e="event in ministry  and 75000 Tsh for clothes and shoes. The table bellow show ministry expendicture in";
	...
	$FinanceTotal = 0;
	 $no6 = 1;
	  ...
	  while ($finance_query=mysqli_fetch_array($finance_event)) 
		...
		$nbfine="The Total Budget in ".$qfine['MinisterPossition']." in academic yaer ".$leaderow['ElectedYear']." is ".$Total_finance;
		$fpdf -> Ln(15);
		$fpdf -> SetFont('Times','B',12);
		...
		$totalbg="The total budget of all ministry in maso government in academic year ".$leaderow['ElectedYear']." is ".$TotalBudget." Tsh.";
		$fpdf -> Ln(10);
		$fpdf -> SetFont('Times','B',13);
	...
	{
		echo "<script> alert('MINISTER OF FINANCE IS NOT SELECTED IN THIS ACADEMIC YEAR'); </script> .<script>window.location='index.php'</script>";
	}
