					...
					<ul class="nav nav-bg-cl">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="student1.php"><i class="fa fa-id-card-o"></i> <span>All student</span></a></li>
									...
									<li><a href="report.php" target="_blank"><i class="fa fa-file-pdf-o"></i> <span>Report</span></a></li>
								</ul>
							</div>
						</li>
						<li class="dropdown">
