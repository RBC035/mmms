					...
					<div class="panel panel-headline ">
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										<span class="icon"><a href="student_health.php" class=""><i class="fa fa-graduation-cap"></i></a></span>
										<p>
											<?php
												$student = "select * from student where HealthInfo='Has'  && StudentStatus = 'Enable'";
												$stdsql = mysqli_query($con,$student);
												$std = mysqli_num_rows($stdsql);
											?>
											<span class="number"><?php echo $std; ?></span>
											<span class="title">Students Health</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
