					...
					<ul class="nav nav-bg-cl">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="student_education.php"><i class="fa fa-id-card-o"></i> <span>All student</span></a></li>
									<li><a href="Insurence_min.php"><i class="fa fa-medkit"></i> <span>Std Health</span></a></li>
									<li><a href="../../dash_dean/pages/report_all.php" target="_blank"><i class="fa fa-file-pdf-o"></i> <span>Report</span></a></li>
								</ul>
							</div>
						</li>
						<li class="dropdown">
