										...
										<table class="table  table-bordered table-hover" id="dataTables-example" >
											...
											<tbody>
												...
												<tr style="color: #000080; font-size: 14px;">
													...
													<td>
														<a href="std_loan_edt.php?Change=<?php echo $row['LoanID']; ?>">
															<span class="fa fa-send " style="padding-left: 29%; color: #000080;" title="Edit">
															</span>
														</a>
													</td>
													<td>
														<a href="std_loan_del.php?Ddelete=<?php echo $row['LoanID'];   ?>" onclick="return confirm('Are you sure want to delete..?')">
