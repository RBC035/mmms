						...
						<div class="clearfix">
							...
							<div class="custom-tabs-line tabs-line-bottom left-aligned">
								<ul class="nav" role="tablist">
									<li class="active"><a href="#tab-bottom-left1" role="tab" data-toggle="tab">All students</a></li>
								</ul>
							</div>
								...
								<div class="panel-heading">
									...
									<div style="margin-right: 14px;">
										<span class="label label-danger" style="font-size: 19px;"> 
												<a href="../../dash_dean/pages/report_all.php" style="color:white;" class="fa fa-download " target="_blank"> Print doc &nbsp;<i class="fa fa-file-pdf-o"></i></a>  
										</span>
									</div>
								</div>
							</div>
