<?php
	...
	$fpdf -> Cell(190,8,'STUDENT WHO DONT HAVE LOAN  IN MASO GOVERNMENT',0,0,'C');
	$fpdf -> Ln(10);
	...
	$fpdf -> Cell(32,8,'PhoneNumber',1,0);

	// code to fecth
	$stdloan = mysqli_query($con,"select * from loan");
	while ($stdrow = mysqli_fetch_assoc($stdloan)) 
	{
		$fpdf -> Ln(8);
		$fpdf -> SetFont('Times','',11);
		$fpdf -> SetTextColor(12,22,102);
		$fpdf -> Cell(48,8,$stdrow['RegNo'],1,0);
	}
