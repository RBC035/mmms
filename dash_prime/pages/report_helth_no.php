<?php
	...
	$fpdf -> Cell(190,8,'LIST OF STUDENT WHO DONT HAVE HEALTH INSUARENCE IN MASO GOVERNMENT',0,0,'C');
	$fpdf -> Ln(10);
	...
	$fpdf -> Cell(35,8,'Phone',1,0);
	$fpdf -> Cell(28,8,'Gender',1,0);
