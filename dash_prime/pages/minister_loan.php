					...
					<div class="panel panel-headline ">
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										<span class="icon"><a href="student_loan.php" class=""><i class="fa fa-graduation-cap"></i></a></span>
										<p>
											<?php
												$student = "select student .* , loan .* from student , loan where student.RegNo = loan.RegNo && StudentStatus = 'Enable'";
												$stdsql = mysqli_query($con,$student);
												$std = mysqli_num_rows($stdsql);
												
											?>
											<span class="number"><?php echo $std; ?></span>
											<span class="title">Students Loan</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<?php
											$select = "select student .* , selectedleader .* from student , selectedleader where student.RegNo = selectedleader.RegNo && not Possition ='Former President' && StudentStatus='Enable'  && Possition !='Former DSR' && Possition != 'Former Vice President'";
