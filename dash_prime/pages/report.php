<?php
	...
	$fpdf -> Cell(190,8,'MINISTER OF WOMEN REPORT IN MASO GOVERNMENT',0,0,'C');
	$fpdf -> Ln(10);
	...
	$fpdf -> Cell(32,8,'Phone',1,0);

	// code to fecth
	$query=mysqli_query($con,"select * from student where Gender='Female' && StudentStatus ='Enable' ");
	while($row=mysqli_fetch_array($query))
		{
			...
			$fpdf -> Cell(32,8,$row['PhoneNumber'],1,0);
		}
