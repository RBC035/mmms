					...
					<ul class="nav nav-bg-cl">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="student1.php"><i class="fa fa-users"></i> <span>All student</span></a></li>
									<li><a href="student_loan1.php"><i class="fa fa-hospital-o"></i> <span>Std loan</span></a></li>
									<li><a href="Insurence1.php"><i class="fa fa-medkit"></i> <span>Std Health</span></a></li>
								</ul>
							</div>
						</li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
								<i class="fa fa-wpforms"></i> <span>Msr Budgets</span></a>
									<ul class="dropdown-menu  nav" style="border: 0px solid black; width: 100%;">
										...
										<li><a href="budget_report_all.php"><i class="fa fa-newspaper-o"></i> <span>All Msr Budget</span></a></li>
									</ul>
						</li>
						<li><a href="Massege.php" class=""><i class="fa fa-envelope"></i> <span>Massege</span></a></li>
						<!-- <li><a href="event.php" class=""><i class="fa fa-wpforms"></i> <span>Event</span></a></li> -->
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
