<?php
	...
	// code to fecth
	$query=mysqli_query($con,"select student .* , loan .* from student , loan where student.RegNo = loan.RegNo && LoanCategory='ZHESLB' && StudentStatus='Enable'");
	while($row=mysqli_fetch_array($query))
		...
		// $fpdf -> Cell(48,8,$row['RegNo'],1,0);
			$fpdf -> Cell(50,8,$row['FirstName'].", ".$row['MiddleName'].", ".$row['LastName'],1,0);
