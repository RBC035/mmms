						...
						<div class="clearfix">
							...
							<div class="custom-tabs-line tabs-line-bottom left-aligned">
								<ul class="nav" role="tablist">
									...
									<li><a href="#tab-bottom-left4" role="tab" data-toggle="tab">Program </a></li>
									<li><a href="#tab-bottom-left5" role="tab" data-toggle="tab">Department </a></li>
								</ul>
							</div>
