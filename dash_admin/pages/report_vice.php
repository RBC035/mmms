<?php
	...
	if ($getID == 0) 
	{
		...
		$fpdf -> Cell(284,8,'VICE PRESIDENT REPORT IN MASO GOVERNMENT',0,0,'C');
		$fpdf -> Ln(10);
		...
		// code to fecth
		$query=mysqli_query($con,"select student .* , selectedleader .* from student , selectedleader where student.RegNo = selectedleader.RegNo && Possition='Vice President' &&  StudentStatus='Enable'");
	...
	else 
	{
		// third line
		$fpdf -> SetTextColor(0,0,0);
		$fpdf -> Cell(284,8,'FORMER VICE PRESIDENT REPORT IN MASO GOVERNMENT',0,0,'C');
		$fpdf -> Ln(10);
		...
		// code to fecth
		$query=mysqli_query($con,"select student .* , selectedleader .* from student , selectedleader where student.RegNo = selectedleader.RegNo && Possition ='Former Vice President' &&  StudentStatus='Enable'");
