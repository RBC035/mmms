		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid"> 
					<form method="post" action="selected_add_status.php" autocomplete="off">
						<div class="row">
									...
									<div class="col-md-10">
										<div class="panel">
											<div class="panel-heading">
												<h3 class="panel-title" >Add minister role information</h3>
												<div class="right">
											...
											<div class="panel-body">
												...
												<div class="form-group">
									                 <label style=" font-family: Times new roman; font-weight: bold; color: #000080;">
								                   	...
								                   	<select name="privillege"   class="form-control" required>
								                        <option></option>
								                    ...
								                    <input type="hidden" name="ld"  class="form-control"  readonly="readonly" value="<?php echo $row['LeaderID'] ;?>">
				                            	</div>
				                            	<div class="form-group">
