...
require_once 'dashbroad.php';
	...
	if ($ID == 0) 
	{
		$msrLoan =mysqli_query($con,"select * from minister where 	MinisterPossition ='Minister of Loan'");
							...
							<div class="custom-tabs-line tabs-line-bottom left-aligned">
								<ul class="nav" role="tablist">
									<?php
										...
										$seleader=mysqli_query($con,"select * from selectedleader where LeaderID ='".$LoanRow['LeaderID']."' && ElectedYear = '". $LeaderQuery['ElectedYear']."'");

									if (mysqli_num_rows($seleader)>0) 
									{
...
?>
	<div class="main-content">
		<div class="container-fluid">
			<dfn style="font-size: 19px; color: black; ">
				Minister of loan is not selected in this academic year
			</dfn>
		</div>
	</div>
...
<?php
	...
	if ($ID == 1) 
	{
		$msrLoan =mysqli_query($con,"select * from minister where 	MinisterPossition ='Minister of Health'");
		$LoanRow= mysqli_fetch_assoc($msrLoan);
...
?>
	<div class="main-content">
		<div class="container-fluid">
			<dfn style="font-size: 19px; color: black; ">
				Minister of health is not selected in this academic year
			</dfn>
		</div>
	</div>
<?php
...
<?php	
	...
	if ($ID == 2) 
	{
		$msrLoan =mysqli_query($con,"select * from minister where 	MinisterPossition ='Minister of Finance'");
		$LoanRow= mysqli_fetch_assoc($msrLoan);
		$LoanRow['MinisterPossition']." ,".$LoanRow['MinisterID'];
		$eventBlock = mysqli_query($con,"select * from event where MinisterID ='".$LoanRow['MinisterID']."' && Estatus= 'RELEASED'");
		$eRow= mysqli_fetch_assoc($eventBlock);
...
?>
	<div class="main-content">
		<div class="container-fluid">
			<dfn style="font-size: 19px; color: black; ">
				Minister of finance is not selected in this academic year
			</dfn>
		</div>
	</div>
<?php
...
<?php
	...
	if ($ID == 3) 
	{
		$msrLoan =mysqli_query($con,"select * from minister where 	MinisterPossition ='Minister of Women'");
		$LoanRow= mysqli_fetch_assoc($msrLoan);
		$LoanRow['MinisterPossition']." ,".$LoanRow['MinisterID'];
		$eventBlock = mysqli_query($con,"select * from event where MinisterID ='".$LoanRow['MinisterID']."' && Estatus= 'RELEASED'");
		$eRow= mysqli_fetch_assoc($eventBlock);
...
?>
	<div class="main-content">
		<div class="container-fluid">
			<dfn style="font-size: 19px; color: black; ">
				Minister of women is not selected in this academic year
			</dfn>
		</div>
	</div>
<?php
...
<?php			
	...
	if ($ID == 4) 
	{
		$msrLoan =mysqli_query($con,"select * from minister where 	MinisterPossition ='Minister of Security'");
		$LoanRow= mysqli_fetch_assoc($msrLoan);
		$LoanRow['MinisterPossition']." ,".$LoanRow['MinisterID'];
		$eventBlock = mysqli_query($con,"select * from event where MinisterID ='".$LoanRow['MinisterID']."' && Estatus= 'RELEASED'");
		$eRow= mysqli_fetch_assoc($eventBlock);
...
?>
	<div class="main-content">
		<div class="container-fluid">
			<dfn style="font-size: 19px; color: black; ">
				Minister of security is not selected in this academic year
			</dfn>
		</div>
	</div>
<?php
...
<?php
	...
	if ($ID == 5) 
	{
		$msrLoan =mysqli_query($con,"select * from minister where 	MinisterPossition ='Minister of Education'");
		$LoanRow= mysqli_fetch_assoc($msrLoan);
		$LoanRow['MinisterPossition']." ,".$LoanRow['MinisterID'];
		$eventBlock = mysqli_query($con,"select * from event where MinisterID ='".$LoanRow['MinisterID']."' && Estatus= 'RELEASED'");
		$eRow= mysqli_fetch_assoc($eventBlock);
...
?>
	<div class="main-content">
		<div class="container-fluid">
			<dfn style="font-size: 19px; color: black; ">
				Minister of education is not selected in this academic year
			</dfn>
		</div>
	</div>
<?php
...
<?php
	...
	if ($ID == 6) 
	{
		$msrLoan =mysqli_query($con,"select * from minister where 	MinisterPossition ='Minister of Information'");
		$LoanRow= mysqli_fetch_assoc($msrLoan);
		$LoanRow['MinisterPossition']." ,".$LoanRow['MinisterID'];
		$eventBlock = mysqli_query($con,"select * from event where MinisterID ='".$LoanRow['MinisterID']."' && Estatus= 'RELEASED'");
		$eRow= mysqli_fetch_assoc($eventBlock);
...
?>
	<div class="main-content">
		<div class="container-fluid">
			<dfn style="font-size: 19px; color: black; ">
				Minister of Information, Arts, Culture and Sports is not selected in this academic year
			</dfn>
		</div>
	</div>
<?php
