										...
										<table class="table  table-bordered table-hover" id="dataTables-example" >
									        ...
									        <tbody>
												<?php
													...
													$query=mysqli_query($con,"select * from selectedleader where Status = 'Elected' && RegNo !='$id' && Possition !='President' && Possition !='Vice President' && ElectedYear ='".$LeaderQuery['ElectedYear']."'");
