		...
		<div class="wrapper">
			<section class="users">
              ...
              inset 0 0 0 0 rgb(0 0 0 / 5%); padding: 10px 30px 20px 0px; ">
        			<?php
        				$crsele=mysqli_query($con,"select * from userole where UserName !='$userID' && Role !='Former CR' && Role !='CR' && Role !='Former Vice President' && Role !='Former Minister of Information' && Role !='Former Minister of Security' && Role !='Former DSR' && Role !='Former Minister of Loan' && Role !='Former Minister of Health'  && Role !='Former Minister of Women' && Role !='Former Minister of Finance' && Role !='Former Prime minister'  && Role !='Former Minister of Education' && Role !='Former President' order by ID desc");
