					...
					<ul class="nav nav-bg-cl">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="student.php"> <span class="icon"><i class="fa fa-user"></i></span>Students list</a>
									</li>
									<li><a href="former_cr.php"> <span class="icon"><i class="fa fa-user-circle"></i></span>Former cr</a>
									</li>
									<li><a href="PDF2_file.php "  target="_blank"><i class="fa fa-file-pdf-o"></i> <span>Std Report</span></a></li>
								</ul>
							</div>
						</li>
						<li class="dropdown">
						...
						<li><a href="Massege1.php" class=""><i class="fa fa-envelope"></i> <span>Massege</span></a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
