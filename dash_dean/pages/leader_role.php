									...
									<div class="panel-body">
										<table class="table  table-bordered table-hover" id="dataTables-example" >
											...
											<tbody>
												<?php
													$no = 1;
													$query1=mysqli_query($con,"select * from userole where Role != 'Minister of Loan' && Role != 'Former Minister of Loan' && Role != 'Minister of Health' && Role != 'Former Minister of Health' && Role != 'Minister of Women' && Role != 'Former Minister of Women' && Role != 'Minister of Education' && Role != 'Former Minister of Education' && Role != 'Minister of Information' && Role != 'Former Minister of Information' && Role != 'Minister of Security' && Role != 'Former Minister of Security'  && Role != 'Prime minister' && Role != 'Former Prime minister'  && Role != 'CR' && Role != 'Former CR' ");
													while ($row1=mysqli_fetch_array($query1)) 
													{
													$query=mysqli_query($con,"select * from student where RegNo ='".$row1['UserName']."'");
												...
												<tr style="color: #000080; font-size: 14px;">
													...
													<td>
													 	...
													 	{
													 	?>
														 	<a href="leader_role_edt.php?Change=<?php echo $row1['ID']; ?>">
