		...
		if ($DurationUpdate) 
			{
				...
				{
					echo "<script> alert('Error: something goes wrong on userole query'); </script> .<script>window.location='CR.php'</script>";
				}
			...
			{
				echo "<script> alert('Error:43 something wrong on duration handler page'); </script> .<script>window.location='CR.php'</script>";
			}
	}
	else
	{
		echo "<script> alert('Error : Something wrong...'); </script> .<script>window.location='CR.php'</script>";
	}
?>