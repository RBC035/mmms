<?php
	...
	$sele2018 = mysqli_query($con,"select * from selectedleader where ElectedYear='2017/2018' ");
	if (mysqli_num_rows($sele2018)) 
	{
	...
	*/
	...
	else
	{
		...
		// total budget 
		$TotalBudget = $Total_Loan + $Total_Health + $Total_Info + $Total_Edu + $Total_Secu +$Total_finance;
