								...
								<div class="panel-heading">
									<div class="right">
										<span class="label label-primary" style="padding: 9px;"> 
											<a href="../../dash_admin/pages/report_prime.php?ID=1" target="_blank" style="color:white; font-size: 15px" class="fa fa-download"> Print report &nbsp; <i class="fa fa-file-pdf-o"></i></a>
										</span>
									</div>
									<h3>FORMER PRIME MINISTERS REPORT IN MASO GOVERNMENT</h3>
								</div>
								<div class="panel-body">
									<table class="table  table-bordered table-hover" id="dataTables-example" >
										...
										<tbody>
											<?php  
												$no = 1;
												$ministerSelect = mysqli_query($con,"select * from minister where  MinisterPossition ='Former Prime minister'");
											...
											?>
															<td><?php echo $ministerQuery['MinisterPossition']; ?></td>
											<?php
