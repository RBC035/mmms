								...
								<div class="panel-heading">
									<div class="right">
										<span class="label label-primary" style="padding: 9px;"> 
											<a href="../../dash_admin/pages/report_minister.php?ID=0" target="_blank" style="color:white; font-size: 15px" class="fa fa-download"> Print report &nbsp; <i class="fa fa-file-pdf-o"></i></a>
										</span>
									</div>
