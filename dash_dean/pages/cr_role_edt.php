<?php
		...
		$userID=$_GET['Change'];
		$sele="select * from cr where RegNo ='$userID'";
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<form method="post" action="cr_role_upt.php" autocomplete="off">
						<div class="row">
									...
									<div class="col-md-10">
										<div class="panel">
											<div class="panel-heading">
												<h3 class="panel-title" >Class representative information</h3>
												<div class="right">
													<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up" title="Hide page"></i></button>
													 <a href="CR.php" title="Close page"><button type="button"> <i class="lnr lnr-cross" ></i></button></a>
												</div>
											</div>
											<div class="panel-body">
	                                			...
	                                			<div class="form-group">
									                ...
									                <select name="Status"   class="form-control" >
									                    <option><?php echo $row['CrStatus'] ;?></option>
	                                			...
	                                			<div class="form-group">
								                   <label style=" font-family: Times new roman; font-weight: bold; color: #000080;">
								                   	...
								                   	<select name="years"   class="form-control" >
								                        <option><?php echo $row['SelectedYear'] ?></option>
