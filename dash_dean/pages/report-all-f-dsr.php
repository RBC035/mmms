				...
				<div class="row">
					...
					<div class="col-md-9">
						<div class="main-content">
							<div class="panel">
								<div class="panel-heading">
									<h3>FORMER DEPARTMENT STUDENT REPRESENTATIVE REPORT</h3>
									<div class="right">
										<span class="label label-primary" style="padding: 9px;"> 
											<a href="../../dash_admin/pages/report_dsr.php?ID=1" target="_blank" style="color:white; font-size: 15px" class="fa fa-download"> Print report &nbsp; <i class="fa fa-file-pdf-o"></i></a>
										</span>
									</div>
								</div>
